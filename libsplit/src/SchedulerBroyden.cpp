...
SchedulerBroyden::SchedulerBroyden(unsigned nbDevices, DeviceInfo *devInfo,
				   unsigned numArgs,
				   unsigned nbGlobals,
...
void
SchedulerBroyden::initScheduler(const size_t *global_work_size,
...
SchedulerBroyden::getGranu()
{
  ...
  if (iterno >= 2) {
    ...
    double dxJdF = dot(deltaX, JDF, nbDevices-1);
    ...
    scal(1.0 / dxJdF, deltaX, nbDevices-1);
