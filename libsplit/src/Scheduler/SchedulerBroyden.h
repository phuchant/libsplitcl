#ifndef SCHEDULERBROYDEN_H
#define SCHEDULERBROYDEN_H
...
namespace libsplit {
  ...
  class SchedulerBroyden : public SingleKernelScheduler {
  public:

    SchedulerBroyden(BufferManager *buffManager, unsigned nbDevices);
    virtual ~SchedulerBroyden();
